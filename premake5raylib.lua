--[[
	This is a modified version of https://github.com/raylib-extras/game-premake/blob/main/raylib_premake5.lua
...
function link_raylib(raylib_dir)
    links {"raylib"}

    raylib_dir = raylib_dir or get_raylib_dir();
    ...
    filter "system:windows"
        ...
        libdirs { "%{wks.location}/bin/raylib/%{cfg.buildcfg}" }
...
function include_raylib(raylib_dir)
    raylib_dir = raylib_dir or get_raylib_dir();
    includedirs { raylib_dir .."/src" }
    includedirs { raylib_dir .."/src/external" }
    includedirs { raylib_dir .."/src/external/glfw/include" }
